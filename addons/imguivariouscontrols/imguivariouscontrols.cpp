...
static float s_timeline_horizontal_scaling = 1.f;
...
bool TimelineEvent(const char* str_id, float* values,bool keep_range_constant)
{
    ...
    start.y += row_height*0.3f;
    ImVec2 end = start + ImVec2(columnWidth * (values[1] - values[0]) / s_max_timeline_value - 2 * TIMELINE_RADIUS,row_height*0.4f);
