...
struct Node
{
    ...
    Node(int id, const char* name, const ImVec2& pos, float value, const ImVec4& color, int inputs_count, int outputs_count,const char** input_names=NULL,const char** output_names=NULL) {
...
struct NodeGraphEditor	{
    ...
    int node_selected;
    NodeGraphEditor(bool show_grid_= true,bool show_connection_names_=true) {
    ...
    void addNode(int id, const char* name, const ImVec2& pos, float value, const ImVec4& color, int inputs_count, int outputs_count,const char** input_names=NULL,const char** output_names=NULL)	{
        nodes.push_back(Node(id, name, pos,value,color, inputs_count,outputs_count,input_names,output_names));
    }
