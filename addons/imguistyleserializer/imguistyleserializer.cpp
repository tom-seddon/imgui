...
static const char* DefaultStyleNames[ImGuiStyle_Count]={"Default","Gray","Light","OSX","OSXOpaque","DarkOpaque","DefaultInverse","OSXInverse","OSXOpaqueInverse","DarkOpaqueInverse"};
