...
static const char* DefaultStyleNames[ImGuiStyle_Count]={"Default","Gray","Light","OSX","OSXOpaque","DarkOpaque","Soft","DefaultInverse","OSXInverse","OSXOpaqueInverse","DarkOpaqueInverse"};
